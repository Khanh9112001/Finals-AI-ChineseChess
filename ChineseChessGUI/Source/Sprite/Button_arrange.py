...
class Button_arrange(pygame.sprite.Sprite):
    """
    ...
    def __init__(self, piece_name, position_in_screen: Point, piece_size, leftside, position_in_state=Point()):
        ...
        """
        super(Button_arrange, self).__init__()
        # position in state
        ...
        if leftside:
            ...
            self.images = [RED_PIECES_IMAGES[RED_PIECES.index(piece_name)],
                           CLICKED_RED_PIECES_IMAGES[RED_PIECES.index(piece_name)]]
        ...
        self.set_position_in_screen(position_in_screen)

    # set position of sprite in screen
    def set_position_in_screen(self, position_in_screen: Point):

        # get image size to set rect of sprite
        image_size = self.image.get_rect().size
        # set position of sprite
        self.rect = pygame.Rect(position_in_screen.get_position(), image_size)
